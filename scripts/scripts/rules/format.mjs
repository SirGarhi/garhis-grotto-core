...
export function subFeatures(){
    ...
    CONFIG.DND5E.featureTypes.path = "Path Feature"
...
export function sheets(){
    CONFIG.DND5E.sourcePacks.BACKGROUNDS = "garhis-grotto.gg-background"
    CONFIG.DND5E.sourcePacks.CLASSES = "garhis-grotto.gg-class"
    CONFIG.DND5E.sourcePacks.RACES = "garhis-grotto.gg-ancestry"
