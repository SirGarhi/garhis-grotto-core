...
export function conditions(){
	...
	CONFIG.DND5E.conditionTypes.intoxicated = {
		label:"Intoxicated",
		reference:"Compendium.garhis-grotto-module.gg-journal-rule.JournalEntry.USwOGFGJbk8zoR06.JournalEntryPage.55CsgrPatqRKSWku",
		icon:"modules/garhis-grotto-module/assets/art/02_icons/00_effects/status-conditions/intoxicated.webp"
	}
